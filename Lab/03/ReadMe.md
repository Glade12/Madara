...
![](./screenshots/i.png)
<p>Рис.1 Интерфейс <br></p>

![](./screenshots/d.png)
<p>Рис.2 Игрок удалил ряд розовых шаров</p>

![](./screenshots/l.png)
<p>Рис.3 Игрок проиграл</p>

![](./screenshots/ng.png)
<p>Рис.4 Игрок нажал на кнопку "Новая игра" </p>

![](./screenshots/b.png)
<p>Рис.5 Игрок нажал кнопку "Сделать ход"</p>
...
~~~
<h3>Вывод</h3><br>
В ходе проведения лабораторной работы, мы закрепили навыки разработки программ с простым графическим интерфейсом пользователя на зыке Python при помощи библиотеки Tkinter, получили представление о разработке простых игровых приложений, а также написали простейшую игру на языке программирования Python.

<h3>Каталоги</h3><br>

[Python](./Python) [Screenshots](./screenshoots) [Pictures](./pictures)
